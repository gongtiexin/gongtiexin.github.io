...
NexT.utils = {
    ...
    window.addEventListener('scroll', () => {
      ...
      if (backToTop || readingProgressBar) {
        ...
        var contentVisibilityHeight =
          docHeight > winHeight ? docHeight - winHeight : document.body.scrollHeight - winHeight;
  ...
  registerActiveMenuItem: function() {
    document.querySelectorAll('.menu-item').forEach(element => {
      ...
      var isSubPath =
        target.pathname !== CONFIG.root && location.pathname.indexOf(target.pathname) === 0;
  ...
  initSidebarDimension: function() {
    ...
    if (CONFIG.scheme === 'Pisces' || CONFIG.scheme === 'Gemini')
      sidebarSchemePadding += sidebarOffset * 2 - 12;
  ...
  updateSidebarPosition: function() {
    ...
    if (typeof display !== 'boolean') {
      ...
      display =
        CONFIG.sidebar.display === 'always' || (CONFIG.sidebar.display === 'post' && hasTOC);
    }
    if (display) {
